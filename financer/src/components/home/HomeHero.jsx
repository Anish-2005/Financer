      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4 px-4 sm:px-0">
          <motion.button
            ...
            className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-xl bg-gradient-to-r from-emerald-500 to-blue-600 text-white font-semibold text-base sm:text-lg shadow-2xl shadow-emerald-500/30 hover:shadow-emerald-500/50 transition-all"
          >
            Start Free Trial
          </motion.button>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className={`w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg backdrop-blur-sm transition-all ${
              isDark
