    ...
    <div className="relative z-10 container mx-auto max-w-7xl px-4 pt-24 sm:pt-32 pb-12 sm:pb-16">
      ...
      >
        ...
        <motion.div
          ...
          className={`inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full backdrop-blur-sm transition-colors text-xs sm:text-sm ${
            isDark
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed transition-colors ${
        ...
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 pt-8 sm:pt-12 max-w-4xl mx-auto"
        >
          {[
            ...
            >
              <div className="text-xl sm:text-3xl font-bold bg-gradient-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent">
                {stat.value}
              </div>
