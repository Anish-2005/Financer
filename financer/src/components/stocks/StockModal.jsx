  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <motion.div
        ...
        className={`backdrop-blur-xl rounded-3xl p-4 sm:p-6 md:p-8 max-w-5xl w-full max-h-[90vh] overflow-y-auto transition-colors ${
          isDark
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          <div className="space-y-6">
            ...
            <motion.div
              ...
              className={`backdrop-blur-sm rounded-2xl p-4 sm:p-6 transition-colors ${
                isDark
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-1.5 sm:p-2 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex justify-between items-center p-3 sm:p-4 rounded-xl bg-gradient-to-r from-emerald-500/10 to-blue-500/10">
                ...
                <div className={`flex justify-between items-center p-3 sm:p-4 rounded-xl transition-colors ${
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-1.5 sm:p-2 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600">
              ...
              <div className="space-y-2 sm:space-y-3">
                {[
                  ...
                  <div key={index} className={`flex justify-between items-center p-2 sm:p-3 rounded-xl transition-colors ${
                    isDark ? 'bg-slate-700/30' : 'bg-slate-50/50'
                  }`}>
                    <span className={`font-medium transition-colors text-sm sm:text-base ${
                      isDark ? 'text-slate-300' : 'text-slate-700'
                    }`}>{item.label}</span>
                    <span className={`font-semibold text-sm sm:text-base ${item.color}`}>
                      {item.value}
                    </span>
                  </div>
                ))}
          ...
          <div className="space-y-6">
            ...
            {stock.chartToday && (
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                  <div className="p-1.5 sm:p-2 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600">
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="p-1.5 sm:p-2 rounded-xl bg-gradient-to-br from-orange-500 to-red-600">
