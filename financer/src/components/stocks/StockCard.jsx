    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mb-3 sm:mb-4">
          <p className={`text-xl sm:text-2xl font-bold mb-2 transition-colors ${
            isDark ? 'text-white' : 'text-slate-900'
          }`}>
            {stock.lastPrice}
          </p>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5 sm:gap-2 text-emerald-400 font-semibold group-hover:gap-2 sm:group-hover:gap-3 transition-all">
