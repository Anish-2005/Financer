  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 gap-4">
        <div>
          <div className="inline-flex px-3 sm:px-4 py-2 rounded-full bg-pink-500/10 border border-pink-500/20 mb-2 sm:mb-4">
        ...
        <div className="space-y-2 sm:min-w-[180px]">
          ...
          <div className="relative">
            ...
            <select
              ...
              className={`w-full pl-10 pr-4 py-2 rounded-xl border transition-all text-sm sm:text-base ${
                isDark
      ...
      {sortedFinancials.length === 0 ? (
        <div className="text-center py-8 sm:py-12 px-4">
          <TrendingUp className={`w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 transition-colors ${
              ...
              >
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center text-white font-bold text-base sm:text-lg"
                  ...
                  <motion.button
                    ...
                    className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-red-500/20 text-red-400 hover:bg-red-500/30 flex items-center justify-center flex-shrink-0"
                  >
