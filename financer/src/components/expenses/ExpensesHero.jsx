...
const ExpensesHero = ({
  ...
  return (
    <div className="relative z-10 container mx-auto max-w-7xl px-4 pt-24 sm:pt-32 pb-12 sm:pb-20">
      {/* Hero Section */}
      <motion.div
      ...
      >
        <div className="inline-flex px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-4 sm:mb-6">
          <span className="text-emerald-400 font-semibold text-xs sm:text-sm">Expense Tracker</span>
        </div>
        <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-6 transition-colors ${
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="sm:col-span-1">
            <label className={`block text-xs sm:text-sm font-medium mb-2 transition-colors ${
            ...
            <input
              ...
              step="0.01"
              min="0"
              className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border transition-all text-sm sm:text-base ${
                isDark
          ...
          <div className="sm:col-span-1 flex items-end">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 shadow-lg hover:shadow-xl text-sm sm:text-base"
            >
              Add Expense
            </motion.button>
          </div>
